...
public class ResetPassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        email = findViewById(R.id.forgotEmailReset);
        recover=findViewById(R.id.toRecoveResetr);
        progressBar =findViewById(R.id.progressRecoverReset);
                ...
                if(snapshot.exists())
                {
                    auth.sendPasswordResetEmail(inputEmail).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            {
                                Toast.makeText(ResetPassword.this, "Opps! something went wrong", Toast.LENGTH_SHORT).show();
                                progressBar.setVisibility(View.INVISIBLE);
                            }
                        }
